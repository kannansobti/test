...
public class LambdaExample {
	...
	public static void main(String[] args) {
		...
		Function<Integer, Double> f3 = (Integer t) -> {
			return t / 2.0;
		};
		...
		BiFunction<Integer, Integer, Integer> f5 = (t, u) -> {
			return t * u;
		};
		System.out.print(f5.apply(4, 5));
		//command+shift+o -> import package
		//command+shift+f -> format code
	}

	/*
	 * int x=10; Integer iX=x; Wrapping int x=iX; Unwrapping
	 */
